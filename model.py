...
class Decoder(tf.keras.Model):
    ...
    def __call__(self, x):
        ...
        dec_out_prev += self.mha(self.query(dec_out_prev), self.key(dec_out_prev), self.value(dec_out_prev))
        dec_out_prev = self.layer_norm(dec_out_prev)

        dec_out_prev += self.mha(self.query(x), self.key(dec_out_prev), self.value(dec_out_prev))
